...
const users = [
  {
    ...
    image:
      "https://www.ucsusa.org/sites/default/files/styles/reports_thumbnail/public/images/2019/01/air-quality-eng-cover.JPG?itok=S5hegygC",
    infoLink:
  ...
  },
  {
    ...
    // if it is not '/', like: '/test-site/img/docusaurus.svg'.
    image:
      "https://media.springernature.com/w200/springer-static/cover-hires/journal/41893/2/2",
...
const siteConfig = {
  ...
  headerLinks: [
    ...
    { href: "https://godoc.org/github.com/Amen-Tes/inmap", label: "API" },
  ...
  */
  ...
  repoUrl: "https://github.com/Amen-Tes/inmap",
};
