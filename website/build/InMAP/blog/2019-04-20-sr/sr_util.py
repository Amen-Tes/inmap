...
def run_sr(emis, model, output_variables, emis_units="tons/year"):
    ...
    if _inmap_exe == None:
        ...
        if ost == "Windows":
            ...
            _download("https://github.com/Amen-Tes/inmap/releases/download/v1.6.1/inmap1.6.1windows-amd64.exe", _inmap_exe)
        elif ost == "Darwin":
            _inmap_exe = os.path.join(_tmpdir.name, "inmap_1.6.1")
            _download("https://github.com/Amen-Tes/inmap/releases/download/v1.6.1/inmap1.6.1darwin-amd64", _inmap_exe)
        elif ost == "Linux":
            _inmap_exe = os.path.join(_tmpdir.name, "inmap_1.6.1")
            _download("https://github.com/Amen-Tes/inmap/releases/download/v1.6.1/inmap1.6.1linux-amd64", _inmap_exe)
        else:
